...
- [x] (2026-07-20 11:18Z) WP-05: Produced and verified immutable release `2a716638a65e748926d9fa22e53780fa1b135f1aee6c4ebcc7e5d21249137f7f` from producer commit `6ccc71a4b36f89ffea7cfe34cb64a5c067f81092`; `RELEASE.json` SHA-256 is `c93c297189e9f9c6f92718a566f87da51f60fc08c243ffb0c3f40a023fb037fc`. All six component trees verify. The installed cua_node component contains 3,798 files / 324,854,717 bytes with tree SHA-256 `46c514cbb9b012cc11afc0d8a1428d25fb818e7b2817a9a2bc191595caf81851`; bundled Node reports 24.14.0 and canonical Browser SHA-256 is `085ba347a047473272cafc9f024b59c35dca4b29e44dab8b22eaa80e81e7c60d`.
...
- [x] (2026-07-20 11:51Z) WP-08: Codex Desktop consumer cutover is committed locally as `1a03a7e1e940f16f6f61b1834a3058f3ba9195c2` (verified consumer adapter/package/install) and `d97106669f4dac056573ba91778fdcd2abef49fb` (producer retirement), with no push. Its resolver/projection suites, 1,023-test source suite, standalone and packaged Node/media/OCR/PDF/Playwright acceptance, Linux dev launch smoke, Arch packaging, installed `/opt` verifier, installed-ASAR verification, review, and wrong-hash gates pass. The first package exposed mode-only serialization drift (`0664/0775` to `0644/0755`); explicit no-autoextract plus `bsdtar -p` now makes installed bytes and modes match the producer-attested component trees. Package `chatgpt-desktop 26.707.72221-1` has 7,160 files / zero altered; package SHA is `fefb211cb2f4d84eb3a089a91a7d21d926d3a8837c0fc0ca9947e6423e495826`, ASAR SHA is `6d5a028ef31c420aa977d79703b07a67f208075dccddaa81e000d54c9ee2720f`, and fresh installed GUI/app-server smoke used PIDs `4120290`/`4120819`. The Web Store extension remains installed and untouched. The one real GUI restart remains reserved for the final serial cutover boundary so this controller task is not killed mid-migration.
- [ ] (2026-07-20 13:02Z, final host acceptance active) WP-09: Superseding complete release `a367d5feca770a7dcfd3b8678f4c454713c08124b5e3c63c301cdc44dd62fa23` from producer `932a5ec962ca7c477335f04ee501c2bb57068934` is promoted as standalone `current`; `RELEASE.json` SHA-256 is `2c05b08f1ba5ac3dd6ed66f2128b62bc116486b32d1a03ea4d4e094310bcdf1c`. OpenClaw and OpenCode configs, skills, and all four native-host manifests point to that exact root; the Web Store extension remains untouched. The active daemon path resolves inside the generation. Prior direct/model acceptance is not being repeated; the reserved final Codex GUI restart and exact post-restart IAB/Brave generation proof remain.
...
- [ ] (2026-07-20 13:17Z, replacement release pending) WP-11: The initial ten installed examples passed under bundled Node 24 against release `a367d5fe…`, but final review correctly rejected that as insufficient because three image examples did not await or assert image emission. Source now awaits and validates image blocks plus exact written binary/WebP outputs, exposes Phone singleton terminal state, inventories and hashes installed Phone declarations/lifecycle members, and uses one canonical persistent-Phone capability vocabulary. A physical Phone is not connected, so real-device screenshot/action parity remains externally unavailable. The VM `all` gate passed `isolated-xpra` then exposed a pre-existing fixture target regression; the corrected focused `wayland-pointer` gate now passes all pointer/scroll/extended-control/keyboard cells at `/workspace/artifacts/gui-desktop-smoke/wayland-pointer/20260720T111641Z`. Rebuild/promote the reviewed replacement before resuming `all` and installed acceptance.
...
Final release `2a716638a65e748926d9fa22e53780fa1b135f1aee6c4ebcc7e5d21249137f7f` / manifest `c93c297189e9f9c6f92718a566f87da51f60fc08c243ffb0c3f40a023fb037fc` is installed as standalone `current` and as the verified Codex packaged fallback under `/opt`. OpenClaw and OpenCode both execute direct `sky_cua` and persistent `node_repl` from that generation. Active daemon/native-host path proof, installed Node/media/OCR/PDF/Playwright acceptance, and exact Codex package byte/mode verification are green. Consumer review/commits, the serial Codex GUI restart, and remaining post-restart concurrent/composed live gates are active; WP-10/11 correctly remain deferred until that initial cutover acceptance closes.
