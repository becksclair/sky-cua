...
- `references/node-repl.md`
- `references/toolbox.md`
- `references/troubleshooting.md`
- `recipes/composed-workflows.md`

The `inventories/` directory is generated during release assembly and binds every routed document and runnable example to its SHA-256 digest.
