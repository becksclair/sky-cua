...
pub const COSMIC_HELPER_BINARY: &str = "sky-cua-cosmic-helper";
...
pub fn activate_window(window_id: &str) -> Result<CosmicHelperActivation> {
    run_json_command(["activate-window", "--window-id", window_id])
}
