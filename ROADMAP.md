...
- [ ] Compact MCP tool surface profiles — [`plans/compact_mcp_tool_surface.md`](plans/compact_mcp_tool_surface.md), [`docs/features/compact-mcp-tool-surface.md`](docs/features/compact-mcp-tool-surface.md)
