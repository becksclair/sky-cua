...
const DESCRIPTORS: &[BackendDescriptor] = &[
    BackendDescriptor {
        ...
        list_note: "Window list came from the GNOME Shell extension.",
    ...
    BackendDescriptor {
        ...
        list_note: "Window list came from GNOME Shell Introspect.",
    ...
    BackendDescriptor {
        ...
        list_note: "Window list came from the COSMIC Wayland helper.",
    ...
    BackendDescriptor {
        id: KWIN_BACKEND,
        failure_label: "KWin",
        list_note: "Window list came from KWin/Plasma DBus scripting.",
    ...
    BackendDescriptor {
        ...
        list_note: "Window list came from Hyprland hyprctl.",
    ...
    BackendDescriptor {
        id: I3_BACKEND,
        failure_label: "i3",
        list_note: "Window list came from i3-msg.",
    ...
    BackendDescriptor {
        id: X11_BACKEND,
        failure_label: "X11",
        list_note: "Window list came from X11 EWMH metadata.",
