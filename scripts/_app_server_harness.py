...
def with_plugin_mention(prompt: str) -> str:
    return (
        ...
        " inspect the current screenshot to confirm the target field and whether it already contains"
        " text; clear or select stale contents before `type_text` when replacement is intended. Re-run"
